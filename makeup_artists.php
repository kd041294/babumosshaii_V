...
$resultMakeup = getMakeupPackageList();
$packages = ($resultMakeup['status'] && !empty($resultMakeup['data']))
    ? $resultMakeup['data']
    : [];
?>
<title>Makeup Packages | BabuMosshaii Event & Co.</title>
...
<style>
    ...
    .hero-section {
        ...
        background: linear-gradient(135deg, rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.5)),
            url('assets/images/artist_images/makeup_background.png');
...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <h1>Find Best Makeup Packages</h1>
            <p>Book professional makeup artists for your wedding & other events</p>
        </div>
    </section>
                        ...
                        <div class="card artist-card">
                            ...
                            <div class="artist-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="<?= $routes['makeup_profile'] . '?id=' . encryptData($pkg['_id']) ?>"
                                        class="btn btn-book">
            ...
            <?php else : ?>
                ...
                <div class="col-12">
                    <div class="coming-soon-box text-center p-5">
                        ...
                        <h4 class="fw-bold mb-2">Exciting Makeup Packages Coming Soon 🎉</h4>

                        <p class="text-muted mb-3">
                            We're onboarding talented makeup artists in your area.
